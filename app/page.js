    ...
    return (
        <main className="bg-gray-300 flex flex-col h-screen w-screen">
            <div className="flex flex-col h-screen">
                ...
                <div className='flex object-center align-middle flex-row bg-zinc-800 rounded-b-3xl w-screen gap-4 content-center justify-center'>
                  <div className="flex flex-col w-6 text-white h-6 absolute left-4 top-1 bg-red-600 rounded-md text-center object-center cursor-pointer" onClick={onPlayerClose}>
                    X
                  </div>
                  <div className="relative left-1">
                    {playervisible ? <img src={`${song_playing_data.album.cover_xl}`} alt="album1" width={100} height={100} className={` h-2/3 aspect-square w-fit rounded-full ${playing ?"animate-spin" : "animate-none"} hover:animate-none ease-out duration-300 aspect-square object-cover` }/> : null}
                  </div>
                   <div className="flex flex-col h-fit ">
                    <h1 className="text-white text-center">{song_playing_data.title_short}</h1>
                  </div>
...
</svg>:                    <svg className='w-fit h-full p-1 ' fill="#FFFFFF" width="800px" height="800px" version="1.1" id="Layer_1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" >
